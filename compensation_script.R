...
plotEvents(x = re, which = "all", n_events = 100, name_ext = "prelim") # out_path = ...

# estimate population separation cutoffs
re <- estCutoffs(x = re)  
plotYields(x = re, which = c(0, bc_ms)) # out_path = ...
...
plotEvents(x = re, which = "all", n_events = 100, name_ext = "_final") # out_path = ...
