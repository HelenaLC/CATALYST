...
### Example 1: Type- & state-markers {#plotMultiHeatmap-example1}
...
### Example 2: CDx markers & cluster frequencies {#plotMultiHeatmap-example2}
...
### Example 3: Selected markers {#plotMultiHeatmap-example3}
...
for (f in names(cs)) {
    ...
    for (i in seq_along(q@top_annotation@anno_list))
        q@top_annotation@anno_list[[i]]@label <- NULL
