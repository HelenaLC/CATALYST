...
To this end, we fit a three-paramter log-logistic function [@Finney] to the yields function with the `LL.3` function of the `r CRANpkg("drc")` R package [@drc]. As an adequte cutoff estimate, we compute the first minimum of the forth derivatve, which marks the and of the plateu regime and on-set of yield decline (see figure below).
