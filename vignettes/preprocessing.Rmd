...
## `gateCytof`: Rectangular, eliptical & polygonal gates
...
### Example 2: Partly specific eliptical gates

Gating parameters can be applied in a group-specific manner. In the example below, we first gate for cells with respect to their DNA expression applying a 95%-quantile (argument `q`) eliptical gate separately for each sample. Secondly, we loosen the gate for one sample and tighten it for the other.
