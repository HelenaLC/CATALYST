...
`r Rpackage("CATALYST")` provides an implementation of bead-based normalization as described by Finck et al. [@Finck2013]. Here, identification of bead-singlets (used for normalization), as well as of bead-bead and cell-bead doublets (to be removed) is automated as follows: 
...
1. bead-bead doublets are removed by applying a $\pm5\;mad$ rule to events identified in step 2. The remaining bead events are used for normalization.
